...
export default function EtcCategoryPage() {
  return (
    <div className="container mx-auto p-4 sm:p-6">
      ...
      <h1 className="text-3xl font-bold mb-2">Etc</h1>
      <p className="text-gray-500 mb-6">Other miscellaneous utilities.</p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
        <Link href="/utils/booth-algorithm-multiplier" passHref>
          <Card className="h-full hover:bg-gray-50 transition-colors">
            ...
            <CardContent>
              <p className="text-gray-600">Visualize Booth's multiplication algorithm.</p>
            </CardContent>
          </Card>
        </Link>
      </div>
